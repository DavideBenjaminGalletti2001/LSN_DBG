...
//Read initial configuration
  ...
  if(restart)
  {
    ReadConf.open("OUTPUT_FILE/"+ PHASE + "_FILE/EQUILIBRAZIONE/config.out");
    ReadVelocity.open("OUTPUT_FILE/" + PHASE + "_FILE/EQUILIBRAZIONE/velocity.out");
...
void Averages(int iblk) //Print results for current block
{
   ...
   ofstream Epot, Ekin, Etot, Temp, Pres;
    ...
    Epot.open("OUTPUT_FILE/"+ PHASE + "_FILE/output_epot.dat",ios::app);
    Ekin.open("OUTPUT_FILE/"+ PHASE + "_FILE/output_ekin.dat",ios::app);
    Temp.open("OUTPUT_FILE/"+ PHASE + "_FILE/output_temp.dat",ios::app);
    Etot.open("OUTPUT_FILE/"+ PHASE + "_FILE/output_etot.dat",ios::app);
    Pres.open("OUTPUT_FILE/"+ PHASE + "_FILE/output_pres.dat",ios::app);

    if (Epot.fail() || Ekin.fail() || Temp.fail() || Etot.fail() || Pres.fail())
    {
...
void ConfFinal(void)
{
  ...
  WriteConf.open("OUTPUT_FILE/"+PHASE+"_FILE/config.out");
  WriteVelocity.open("OUTPUT_FILE/"+PHASE+"_FILE/velocity.out");
  for (int i=0; i<npart; ++i)
  {
