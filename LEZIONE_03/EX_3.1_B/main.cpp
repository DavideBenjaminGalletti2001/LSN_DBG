...
int main (int argc, char *argv[]){
    ...
    {
        sum1=0.;
        for(int j=0; j<NUM_THROWS_PER_BLOCK; j++) sum1+=f1(TEMPO_SCADENZA, PASSO);
    ...
    {
        sum2=0.;
        for(int j=0; j<NUM_THROWS_PER_BLOCK; j++) sum2+=f2(TEMPO_SCADENZA, PASSO);
